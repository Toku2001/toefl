...
## 進め方(2026/06/24 更新)
- 1. Reading.Listening.Speakingを重点的に鍛える
- 2. 基礎文法の理解に時間を割く→ IELTSの対策に延長させるため

## 試験受験日
- 2026年8月1日　(50-60点台) IELTS：5.5
- 2026年9月末　IELTS 6.0
- 2026年12月上旬 IELTS 7.0

## 発音プレビュー一覧（番号連動）

以下は `xxwords.md` と対応する発音プレビュー（`index.html`）です。README 上のリンクをクリックするとプレビューを開けます。

| 番号 | 元ファイル | ファイルパス |
|---|---|---|
| 03 | `Archaeology/03/03words.md` | [Archaeology/03/03words_pronunciation/index.html](Archaeology/03/03words_pronunciation/index.html) |
| 04 | `Archaeology/04/04words.md` | [Archaeology/04/04words_pronunciation/index.html](Archaeology/04/04words_pronunciation/index.html) |
| 05 | `ArtHistory/05/05words.md` | [ArtHistory/05/05words_pronunciation/index.html](ArtHistory/05/05words_pronunciation/index.html) |
| 06 | `AmericanHistory/06words.md` | [AmericanHistory/06words_pronunciation/index.html](AmericanHistory/06words_pronunciation/index.html) |
| 07 | `History/07words.md` | [History/07words_pronunciation/index.html](History/07words_pronunciation/index.html) |
| 08 | `AmericanHistory/08words.md` | [AmericanHistory/08words_pronunciation/index.html](AmericanHistory/08words_pronunciation/index.html) |
| 09 | `AmericanHistory/09words.md` | [AmericanHistory/09words_pronunciation/index.html](AmericanHistory/09words_pronunciation/index.html) |
| 10 | `AmericanHistory/10words.md` | [AmericanHistory/10words_pronunciation/index.html](AmericanHistory/10words_pronunciation/index.html) |
| 11 | `BusinessAsministration&Economics/11words.md` | [BusinessAsministration&Economics/11words_pronunciation/index.html](BusinessAsministration&Economics/11words_pronunciation/index.html) |
...
- 新しい `xxwords.md` の音声ページを生成したら、この表へ番号・元ファイル・`index.html` リンクを必ず追加する。
